						...
						<Carousel className="w-10/12 m-auto text-base">
							<CarouselContent>
								...
								<CarouselItem className="text-balance text-center ">
									...
									<p>
										Pronto! O pagamento será creditado na
										hora e você receberá um e-mail de
										confirmação.
									</p>
								</CarouselItem>
							</CarouselContent>
